        ...
        const result = await sendOne({
          ...
          html: `
            ...
            <div style="font-family:-apple-system,Segoe UI,Roboto,Arial,sans-serif;max-width:460px;margin:0 auto;padding:24px;color:#1f2937;">
              <h2 style="color:#1F5EDC;margin:0 0 4px;">Ustoz platformasi</h2>
              ...
              <div style="font-size:34px;font-weight:700;letter-spacing:8px;color:#1F5EDC;background:#f1f5f9;border-radius:10px;text-align:center;padding:16px 0;margin:12px 0;">${otp}</div>
              ...
              <p style="color:#9ca3af;font-size:12px;margin:0;">Ustoz — onlayn ta'lim platformasi · <a href="https://ustozedu.uz" style="color:#1F5EDC;text-decoration:none;">ustozedu.uz</a></p>
            </div>
          `,
        });
        if (result.success) {
