...
const NAV_ITEMS: NavItem[] = [
  ...
  { labelKey: 'subscription.title', icon: 'SparklesIcon', href: '/student-subscription' },
...
export default function StudentSidebar({ mobileOpen, onMobileClose }: StudentSidebarProps) {
        ...
        <div className="border-t border-border p-3">
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-xs text-muted-foreground truncate">{t('teacher.sidebarRoleStudent')}</p>
            </div>
