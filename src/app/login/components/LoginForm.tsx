      ...
      <div className="space-y-6">
        ...
        <div className="flex gap-2 p-1 bg-muted rounded-lg">
          ...
          <button
            type="button"
            disabled
            className="flex-1 py-2.5 px-4 rounded-md text-sm font-medium text-muted-foreground/50 cursor-not-allowed relative"
          >
            <div className="flex items-center justify-center gap-2">
              <Icon name="PhoneIcon" size={18} />
              <span>{t('auth.phoneTab')}</span>
              <span className="text-[10px] px-1.5 py-0.5 bg-muted rounded font-medium">{t('auth.comingSoon')}</span>
            </div>
          </button>
        </div>
